...
require_once ('config.php'); /*require_once: check if the code in config.php
alreadey exist here if note include it
 */
...
<html lang="en">
  ...
  <body>
    ...
    <div class="cont-main" style="background:url(<?php echo baseAssetsUrl.'images/bg-1.jpg';?>)">
        <div class="container">
            <div class="row">
                <div class="col-sm-12">
                ...
                if (isset($_POST['submit'])) 
                {
                    ...
                    if (checkEmpty($mobile) && checkEmpty($name)) 
                    {
                        ...
                        $sql  = "INSERT INTO orders (`order_name`,`order_email`,`order_phone`,`order_service_id`,`order_city_id`,`order_notes`)
                            VALUES ('$name','$email','$mobile','$service','$city','$notes')
                         ";
                         if (insert($sql)){
                             $success_message = "your order sent succesfully";
                         };
                    }
                    else 
                    {
